...
class Ghost {
    ...
    ghostBody() {
        ...
        this.ctx.beginPath();
        // this.ctx.arc(1, 1 , 1, Math.PI, 1.5 * Math.PI, false);
        // this.ctx.arc(1, 1, 1, 1.5 * Math.PI, 2 * Math.PI, false);
        this.ctx.font = "20px Arial";
        if(this.color =='rgb(221, 0, 0)'){
            this.ctx.fillText('Q', 8, 8);
            
        }
        else if(this.color =='rgb(255, 153, 153)') {this.ctx.fillText('C', 8, 8);}
        else if(this.color =='rgb(255, 153, 0)') {this.ctx.fillText('E', 8, 8);}
        else if(this.color =='rgb(102, 255, 255)') {this.ctx.fillText('O', 8, 8);}
